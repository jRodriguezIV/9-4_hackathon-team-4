...
export default function TestComponent() {
    ...
    return (
        <div className="test">
            <form>
                <h1 className="header">Dyslexia Test</h1>
                <p className="header" style={{marginBottom:"5vh"}}>Select the checkbox if your answer to the question is <strong>"yes"</strong>.</p>
                <div>
                    <input
                        className="check"
                        id="readSlowly"
